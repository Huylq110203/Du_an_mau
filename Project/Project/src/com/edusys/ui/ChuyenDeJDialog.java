...
public class ChuyenDeJDialog extends javax.swing.JDialog {
    ...
    if (txtMaCD.getText().trim().isEmpty() ||
        txtTenCD.getText().trim().isEmpty() ||
        txtThoiLuong.getText().trim().isEmpty() ||
        txtHocPhi.getText().trim().isEmpty() ||
        lblHinh.getToolTipText() == null) {
        MsgBox.alert(this, "Vui lòng điền đầy đủ thông tin trước khi thêm!");
        return;
    }
    ...
    try {
        ...
        if (thoiLuong <= 0 || hocPhi <= 0) {
            MsgBox.alert(this, "Thời lượng và học phí phải lớn hơn 0!");
            return;
        }
        ...
        MsgBox.alert(this, "Thời lượng và học phí phải là số hợp lệ!");
    } catch (Exception e) {
    ...
    ChuyenDe getForm(){
        ...
        cd.setHinh(lblHinh.getToolTipText()); // Lấy tên hình từ ToolTip đưa vào LABEL
        return cd;
    }
